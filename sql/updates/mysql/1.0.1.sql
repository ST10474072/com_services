...
ALTER TABLE `#__services_items` ADD INDEX IF NOT EXISTS `idx_alias` (`alias`);
ALTER TABLE `#__services_items` ADD INDEX IF NOT EXISTS `idx_created` (`created`);
ALTER TABLE `#__services_reviews` ADD INDEX IF NOT EXISTS `idx_created` (`created`);
ALTER TABLE `#__services_messages` ADD INDEX IF NOT EXISTS `idx_created` (`created`);